...
8. (2026) [Software Foundations, Volume 6: Separation Logic Foundations](https://softwarefoundations.cis.upenn.edu/slf-current/index.html), by Arthur Charguéraud, version 3.0 (January 7, 2026, Rocq 9.0.0 or later)
9. (2026) [Software Foundations, Volume 7: Security Foundations](https://softwarefoundations.cis.upenn.edu/secf-current/index.html), by Cătălin Hriţcu and Yonghyun Kim, version 1.0 (January 7, 2026, Rocq 9.0.0 or later)
